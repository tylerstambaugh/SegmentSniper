...
//                {
//                    T foundObject = null;
//                    if (data.FirstOrDefault() is BaseEntity<int>)
//                    {
//                        foundObject = data.SingleOrDefault(item => (item as BaseEntity<int>).Id == int.Parse(i[0].ToString()));
//                    }
//                    ;
//                    return foundObject;
//                });
...
//                {
//                    T foundObject = null;
//                    if (data.FirstOrDefault() is BaseEntity<Int64>)
//                    {
//                        foundObject = data.SingleOrDefault(item => (item as BaseEntity<Int64>).Id == long.Parse(i[0].ToString()));
//                    }
//                    ;
//                    return foundObject;
//                });
...
//                {
//                    T foundObject = null;
//                    if (data.FirstOrDefault() is BaseEntity<Guid>)
//                    {
//                        foundObject = data.SingleOrDefault(item => (item as BaseEntity<Guid>).Id == Guid.Parse(i[0].ToString()));
//                    }
//                    ;
//                    return foundObject;
//                });
