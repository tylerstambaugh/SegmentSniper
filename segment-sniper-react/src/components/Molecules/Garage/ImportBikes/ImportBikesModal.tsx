...
const ImportBikesModal = ({ show, onClose }: ImportBikesModalProps) => {
  ...
  const [importGarage, { loading, error }] = useImportGarage();
  ...
  return (
    <Modal show={show} onHide={onClose} className="shadow">
      ...
      <Modal.Body>
        <Col>
          <Row className="m-3">
            This will query your strava activities for the last year and add any
            bikes you've ridden to your garage.
          </Row>
